...
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Constants.BORDER_MAX;
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Constants.BORDER_MIN;
...
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Constants.POINTS_POSITION_H;
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Constants.POINTS_POSITION_W;
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Constants.RACKET_H_POS;
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Images.BACKGROUND_IMAGE;
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Images.BALL_IMAGE;
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Images.GAME_OVER_IMAGE;
import static eu.mrndesign.matned.arkanoid.client.arkanoid.utils.Images.LEVEL_DONE_IMAGE;
...
public class CanvasWidget extends Composite implements GameContract.View {
	...
	public void refreshCanvas() {
		CssColor color = CssColor.make("rgba(" + 255 + ", " + 255 + "," + 255 + ", " + 1 + ")");
	...
	public void gameOver() {
		...
		if (gameCore.getGame().isHoldMoment())
	...
	private String getTime() {
		return Texts.REMAINING_TIME + gameCore.getGame().getTimer().minutes() + ":"
				+ gameCore.getGame().getTimer().seconds();
	}
