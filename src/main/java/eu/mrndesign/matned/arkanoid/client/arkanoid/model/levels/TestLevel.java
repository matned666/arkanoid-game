...
/**
 * Aby sprawdzić jak działa wygranie levelu , żeby nie musieć grać wystarczy w
 * klacie GameCore zmienić w meodzie init() linijkę if (lvl == null) lvl = new
 * Level1(); na if (lvl == null) lvl = new TestLevel();
 */
